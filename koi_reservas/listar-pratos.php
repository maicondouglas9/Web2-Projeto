    ...
    <table>
        ...
        <tbody>
            <?php foreach ($pratos as $prato): ?>
                <tr>
                    <td><?= $prato->getId() ?></td>
                    <td><?= htmlspecialchars($prato->getNome()) ?></td>
                    <td>
                        <a href="editar-prato.php?id=<?= $prato->getId() ?>"><button class="btn-editar">Editar</button></a>
                        <a href="excluir-prato.php?id=<?= $prato->getId() ?>">
