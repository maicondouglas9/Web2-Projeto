...
<body>
    ...
    <div class="reserva-container">
        <form id="form-prato">
            <h2>Reserve sua Mesa - Koi Reservas</h2>
            <label for="nome-reserva">Nome:</label>
            <input type="text" id="nome-reserva" name="nome-reserva" placeholder="Digite seu nome" required>

            <label for="telefone-reserva">Telefone:</label>
            <input type="tel" id="telefone-reserva" name="telefone-reserva" placeholder="(XX) XXXXX-XXXX" required>

            <label for="data-reserva">Data:</label>
            <input type="date" id="data-reserva" name="data-reserva" required>

            <label for="hora-reserva">Hora:</label>
            <input type="time" id="hora-reserva" name="hora-reserva" required>

            <button class="btn-excluir" type="submit">Reservar Mesa</button>
        </form>
    </div>
